...
#include <persistence/database.h>
 ...
 mapReferences["DashBoard"] = new Reference("GuiObject","GenericMap");
...
RepositoryEntry* GuiObjectmapper::getRepositoryEntry()
	...
	entry->addProperty( new PObjectProperty<GenericMap,GuiObject>( "DashBoard" , "GenericMap", &GuiObject::getDashBoard,&GuiObject::setDashBoard ) ); 
	return entry;
 }
